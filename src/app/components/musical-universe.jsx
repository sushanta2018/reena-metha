  ...
  return (
    <section className="musical-universe-wrapper bg-no-repeat bg-cover mt-[45px] py-[80px]">
      <div className="container px-4 mx-auto 2xl:max-w-[1140px]">
        ...
        <div class="md:gap-[24px] gap-[20px] md:columns-2">
          <div className='rounded-2xl overflow-hidden md:mb-[0px] mb-[20px]'>
            <Image class="w-full" src={MusicUniverse01} alt="" />
          </div>
          <div class="md:gap-[24px] gap-[20px] columns-2">
            <div className='rounded-2xl overflow-hidden md:mb-[24px] mb-[20px]'><Image class="w-full" src={MusicUniverse02} alt="" /></div>
            <div className='rounded-2xl overflow-hidden'><Image class="w-full" src={MusicUniverse03} alt="" /></div>
            <div className='rounded-2xl overflow-hidden md:mb-[24px] mb-[20px]'><Image class="w-full" src={MusicUniverse04} alt="" /></div>
            <div className='rounded-2xl overflow-hidden'><Image class="w-full" src={MusicUniverse02} alt="" /></div>
          </div>
        </div>
      </div>
    </section>
